...
if [ ! -d workspace/DSM_DS3612xs_4458 ]; then
	...
	mkdir ./workspace/DSM_DS3612xs_5004
	tar xvf DSM_DS3612xs_5004.pat -C ./workspace/DSM_DS3612xs_5004
fi
...
cp -p ../xpenology/synobios/synobios-cracked-5.1-5004.ko ./rd-orig/lib/modules/synobios.ko
...
cp -p ../xpenology/patches-rd-gz-alpha9/rd-with-gnoboot-5004.patch ./
patch -p0 < ./rd-with-gnoboot-5004.patch
rm -f ./rd-with-gnoboot-5004.patch
...
mount -o loop,offset=32256 Synoboot_5.1-5004_x64_3612xs.img /mnt/img
